...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: fonts.display, fontSize: type["2xl"], fontWeight: "700", color: colors.onSurface, paddingHorizontal: spacing.lg },
  ...
  orderNo: { fontFamily: fonts.display, fontSize: type.lg, fontWeight: "700", color: colors.onSurface },
  addrRow: { flexDirection: "row", alignItems: "center", gap: spacing.sm },
  pin: { width: 10, height: 10, borderRadius: 5 },
  addr: { flex: 1, fontFamily: fonts.text, fontSize: type.base, color: colors.onSurfaceTertiary },
  ...
  amount: { fontFamily: fonts.display, fontSize: type.lg, fontWeight: "700", color: colors.brandPrimary },
