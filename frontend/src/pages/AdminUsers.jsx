...
const PERMISSION_OPTIONS = [
  ...
  ['rider_kyc:force_reonboarding', 'Force Rider Re-onboarding'],
...
const PERMISSION_GROUPS = [
  ...
  { title: 'Rider KYC', items: [['rider_kyc:view', 'View rider KYC'], ['rider_kyc:review', 'Approve and reject riders'], ['rider_kyc:force_reonboarding', 'Force re-onboarding'], ['riders:worker_type', 'Edit worker type'], ['riders:delete', 'Delete riders safely']] },
]
