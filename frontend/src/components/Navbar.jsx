...
export default function Navbar() {
  ...
  const adminMenuLinks = [
    ...
    { to: '/admin/workforce', label: 'Delivery Workforce', show: canAnyAdmin(['workforce:view', 'workforce:manage', 'delivery:manage', 'riders:manage']) },
    { to: '/admin/delivery-zone', label: 'Delivery Zone Settings', show: canAnyAdmin(['workforce:manage', 'delivery:manage', 'riders:manage']) },
