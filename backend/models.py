...
class Order(Base):
    ...
    delivery_service_level = Column(String(30), default="standard")
    ...
    payment_reference = Column(String(150), default="")
    order_source = Column(String(40), default="customer_app", index=True)
    customer_user_id = Column(Integer, nullable=True, index=True)
    created_by_admin_id = Column(Integer, nullable=True, index=True)
    created_by_admin_name = Column(String(150), default="")
    manual_idempotency_key = Column(String(120), nullable=True, unique=True, index=True)
    manual_discount_reason = Column(Text, default="")
    stock_override_reason = Column(Text, default="")
